import { Checkbox, Col, Form, Input, Button, Row, Space, message } from 'antd'
                    ...
                    >
                        ...
                        <div>
                            ...
                            <Select style={{ width: 200 }} onChange={handleCityChange}>
                                {cityData.map((city) => (
                                    <Option key={city.code} value={user?.city ? user?.city : city.code}>
                                        {city.name}
                                    </Option>
                                ))}
                            </Select>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                value={stateUserDetail?.ward ? stateUserDetail?.ward : "ko"}
